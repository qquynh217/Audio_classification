...
traindf=pd.read_csv('data/train_command.csv',dtype=str)
...
model.fit(train_generator,
                    ...
                    # callbacks=keras.callbacks.EarlyStopping(monitor = 'val_accuracy', verbose=1, patience=6)
)
